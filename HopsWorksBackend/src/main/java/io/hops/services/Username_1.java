...
public class Username_1 implements Serializable {
    ...
    public Username_1(String name, String email) {
        this.name = name;
        this.email = email;
    }

    public Username_1(UserDTO dto) {
...
//        }
    ...
    public Username_1(String email) {
        this.email = email;
    }

    public Username_1(String email, String mobilenum, String name, String password, Date registeredon, byte[] salt, int status) {
        this.email = email;
        this.mobileNum = mobilenum;
        this.name = name;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Username_1)) {
            return false;
        }
        Username_1 other = (Username_1) object;
