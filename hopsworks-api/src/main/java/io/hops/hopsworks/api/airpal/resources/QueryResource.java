...
//  }
  ...
  public Response getSaved() { //          @Auth AirpalUser user,
...
//    CreateSavedQueryBuilder createFeaturedQueryRequest
//            = CreateSavedQueryBuilder.featured()
//            .description(description)
//            .name(name)
//            .query(query);
//    if (user != null) {
//      SavedQuery savedQuery = createFeaturedQueryRequest.
...
//  public static Function<Job, DateTime> JOB_ORDERING
//          = new Function<Job, DateTime>() {
//    @Nullable
//    @Override
...
//      Table[] restTables = Arrays.
//              copyOfRange(tablesArray, 1, tablesArray.length);
//
//      recentlyRun = jobHistoryStore.getRecentlyRun(200, tablesArray[0],
//              restTables);
//    }
//
