...
//    final Map<String, List<String>> schemaMap = schemaCache.
//            getSchemaMap(catalog);
...
//    return Response.ok(createTablesWithMetaData(tables, allUsages, updateMap)).
//            build();
...
//    }
  ...
  public Response getTablePartitions(
          ...
          throws ExecutionException {
//    if (isAuthorizedRead(user, defaultCatalog, schema, tableName)) {
//      return Response.ok(getPartitionsWithMetaData(new PartitionedTable("hive",
//              schema, tableName))).build();
//    } else {
//      return Response.status(Response.Status.FORBIDDEN).build();
//    }
    return Response.status(Response.Status.FORBIDDEN).build();
  ...
  public Response getTablePreview(
          ...
          throws ExecutionException {
//    List<HivePartition> partitions = columnCache.
//            getPartitions(schema, tableName);
//
//    Optional<HivePartition> partition = FluentIterable.from(partitions).
//            firstMatch(
...
//    }
//
//    public static PartitionedTableWithMetaData fromPartionedTable(
//            final PartitionedTable table,
//            final long usages,
//            final TimeUnit windowUnit,
//            final int windowCount,
//            final DateTime lastUpdated) {
...
//    final ImmutableList.Builder<PartitionedTableWithMetaData> builder
...
//  }
//
//  private List<HivePartitionItem> getPartitionsWithMetaData(
//          PartitionedTable table)
//          throws ExecutionException {
//    List<HivePartition> partitions = columnCache.
//            getPartitions(table.getSchema(), table.getTable());
//    ImmutableList.Builder<HivePartitionItem> partitionItems = ImmutableList.
//            builder();
//
...
//
//        partitionItems.add(new HivePartitionItem(partition.getName(), partition.
//                getType(), value, updatedAt));
//      }
//    }
//
